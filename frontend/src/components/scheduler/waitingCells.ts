 ...
 * given day. `vacatedTrayIds` (see computeVacatedTrayIds) should be computed from the wider
 * cell universe that also includes stopped cells, so pass it in separately rather than
 * deriving it from `cells`.
 */
